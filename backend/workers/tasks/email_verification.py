...
def send_verification_email(self: Any, user_id: str) -> dict[str, Any]:
    ...
    try:
        ...
        result = db.execute(select(User).where(User.id == parsed_user_id, User.is_active.is_(True)))
  ...
  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 8px;
    ...
    <div style="padding: 24px;">
      ...
      <div style="margin: 32px 0; text-align: center;">
        <a href="{verify_url}" style="display: inline-block; background-color: #2563EB; color: white;
          padding: 12px 32px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">
          Verify Email
        </a>
      </div>
